/* TO DO 
ma-ybe create a couple similar to loadSvgTex() functions, each for different product type
...
//        type_1.id = 'type_1';
        ...
        $('#sub-btn').click( function(e) {
            ...
            if (document.getElementById('type2').checked) {
                ...
                else if (type == 1) // if tees go go to custom Text function, black shirt 
                {
                    color_ver = 2;
                    customText(customTx); 
                }
